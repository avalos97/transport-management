package com.ingenio.transportmanagementservice.domain.Criterias;
...
public class ShipmentSpecification implements Specification<Shipment> {
    ...
    @Override
    public Predicate toPredicate(Root<Shipment> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
